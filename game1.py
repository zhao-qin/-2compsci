...
class Dinosaur():#the class that will manage the in game dinosaur
...
def gameplay():
    global high_score#high_scre is now a global variable that is recognized both inside and outside the function
    gamespeed = 4
    startMenu = False
    gameOver = False
    gameQuit = False
...
def PlayGame():
    ...
    if not isGameQuit:#If the game is not on the intro page, gameplay will start
        gameplay()

PlayGame()#runs function "playgame"