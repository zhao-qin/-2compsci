...
pygame.display.set_caption("Supreme Rush")# the title of the window
...
class Dino():#defining a class that will be the in game dinosaur
...
class Ptera(pygame.sprite.Sprite):#defining a class that will be the pteradactyl in game
    def __init__(self,speed=5,sizex=-1,sizey=-1):
        pygame.sprite.Sprite.__init__(self,self.containers)
